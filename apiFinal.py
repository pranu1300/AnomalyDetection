...
def print_summary():
      ...
      trendPlotURL = "/trend.png?label="+label+"&datafile="+datafile
      if trendType != None:
            trendPlotURL += "&trendtype=" + trendType
      if execSpeed!= None:
      ...
      report = {
            ...
            'lastWeekStat':lastWeekStat.to_dict(),
            'trendPlotURL':trendPlotURL
      }  
      if outFormat == "json":
            return jsonify(report)    
      return render_template("summaryFinal.html", report = report)
